...
public class BlockHelper {
    ...
    public static void postUpdateBlock(World world, BlockPos pos) {
        ...
        if (flag) {
            ...
            if (j2 > 0) {
                if (pos.y >= j1) {
                    BlockReflectionHelper.relightChunk(chunk, pos.x & 15, pos.y + 1, pos.z & 15);
                }
            } else if (pos.y == j1 - 1) {

                BlockReflectionHelper.relightChunk(chunk, pos.x & 15, pos.y, pos.z & 15);
            }
            ...
            if (j2 != k2 && (j2 < k2 || chunk.getSavedLightValue(EnumSkyBlock.Sky, pos.x & 15, pos.y, pos.z & 15) > 0 || chunk.getSavedLightValue(EnumSkyBlock.Block, pos.x & 15, pos.y, pos.z & 15) > 0)) {
                BlockReflectionHelper.propogateSkylightChunk(chunk, pos.x & 15, pos.z & 15);
            }
        }
